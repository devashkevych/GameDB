    ...
    return (
        <div>
            ...
            <ul>
                ...
                {!loading && minLength && <li style={{ listStyleType:'none' }}>Type more characters...</li>}
                {!loading && !minLength && empty && <li style={{ listStyleType:'none' }}>No game found...</li>}
                {!loading && !minLength && !empty && results.map(g => (
